...
import sdb._DbOldTree.DbTreeNode;

public class DbTreeTest implements _DbOldTree.DbTreeIODelegator {

	@Test
	public void testMerge() throws IOException {
		_DbOldTree<Integer, Integer> tree = new _DbOldTree<Integer, Integer>(
				this, "test", 3);
		tree.add(1, 1);
		tree.add(2, 2);
		tree.add(3, 3);
		...
		new _DbOldTree<Integer, Integer>(this, "test", 3).removeMerge(
				tree.root, 0, tree.root.childrenNode[0],
				tree.root.childrenNode[1]);
		Assert.assertEquals("{{1|2->3}3{3|4}}", tree.root.toString());
	}

	@Test
	public void testMergeLeftEmpty() throws IOException {
		DbTreeNode<Integer, Integer> root = new DbTreeNode<Integer, Integer>(3,
				0);
		DbTreeNode<Integer, Integer> left = new DbTreeNode<Integer, Integer>(3,
				1);
		DbTreeNode<Integer, Integer> right = new DbTreeNode<Integer, Integer>(
				3, 2);
		root.leaf = false;
		Object[] array = new Object[1];
		array[0] = 40;
		root.keys[0] = 40;
		root.childrenId[0] = left.id;
		root.childrenNode[0] = left;
		root.childrenId[1] = right.id;
		root.childrenNode[1] = right;
		root.length++;
		left.next = right;
		right.keys[0] = 40;
		right.length++;
		Assert.assertEquals("{{->40}40{40}}", root.toString());
		new _DbOldTree<Integer, Integer>(this, "test", 3).removeMerge(root, 0,
				left, right);
	...
	public void testAddSimple10_70() throws IOException {
		...
		tree.add(40, 40);
		Assert.assertEquals("{{10->20}20{20->30}30{30|40}}",
				tree.root.toString());
		tree.add(50, 50);
		Assert.assertEquals("{{{10->20}20{20->30}}30{{30->40}40{40|50}}}",
				tree.root.toString());
		tree.add(60, 60);
		Assert.assertEquals(
				"{{{10->20}20{20->30}}30{{30->40}40{40->50}50{50|60}}}",
				tree.root.toString());
		tree.add(70, 70);
		Assert.assertEquals(
				"{{{10->20}20{20->30}}30{{30->40}40{40->50}}50{{50->60}60{60|70}}}",
				tree.root.toString());
	}
	...
	public void testAddStress32() throws IOException {
		...
		Assert.assertEquals(
				"{{{1|2|3->4}4{4|5|6->7}7{7|8|9->10}10{10|11|12->13}}"
						+ "13"
						+ "{{13|14|15->16}16{16|17|18->19}19{19|20|21->22}22{22|23|24->25}25{25|26|27->28}28{28|29|30|31|32}}}",
				tree.root.toString());
	}
	...
	public void testAddStressMany() throws IOException {
		...
		for (int o = 3; o <= 101; o += 2) {
			...
			DbTreeNode<Integer, Integer> node = tree.get(tree.root, 1);
			while (node != null) {
		...
		for (int m = 1; m <= max; m++) {
			...
			for (int o = 3; o <= 101; o += 2) {
				...
				for (int n = 0; n < myList.size(); n++) {
					...
					System.out.println("m:" + m + " o:" + o + " n:" + n + " v:"
							+ value);
					tree.remove(value);
	...
	public void testTree70Remove10() throws IOException {
		...
		tree.remove(10);
		Assert.assertEquals(
				"{{{20->30}30{30->40}40{40->50}}50{{50->60}60{60|70}}}",
				tree.root.toString());
	}
	...
	public void testTree70Remove20() throws IOException {
		...
		tree.remove(20);
		Assert.assertEquals(
				"{{{10->30}30{30->40}40{40->50}}50{{50->60}60{60|70}}}",
				tree.root.toString());
	}
	...
	public void testTree70Remove30() throws IOException {
		...
		tree.remove(30);
		Assert.assertEquals(
				"{{{10->20}20{20->40}40{40->50}}50{{50->60}60{60|70}}}",
				tree.root.toString());
	}
	...
	public void testTree70Remove40() throws IOException {
		...
		tree.remove(40);
		Assert.assertEquals(
				"{{{10->20}20{20->30}30{30->50}}50{{50->60}60{60|70}}}",
				tree.root.toString());
	}
	...
	public void testTree70Remove50() throws IOException {
		...
		tree.remove(50);
		Assert.assertEquals(
				"{{{10->20}20{20->30}}30{{30->40}40{40->60}}60{{60->70}70{70}}}",
				tree.root.toString());
	}
	...
	public void testTree70Remove60() throws IOException {
		...
		tree.remove(60);
		Assert.assertEquals(
				"{{{10->20}20{20->30}}30{{30->40}40{40->50}}50{{50->70}70{70}}}",
				tree.root.toString());
	}
	...
	public void testTree70Remove70() throws IOException {
		...
		tree.remove(70);
		Assert.assertEquals(
				"{{{10->20}20{20->30}}30{{30->40}40{40->50}}50{{50->60}60{60}}}",
				tree.root.toString());
	}
	...
	public void test7Tree70Remove30() throws IOException {
		...
		Assert.assertEquals("{{10|20|30->40}40{40|50|60|70}}",
				tree.root.toString());
		tree.remove(30);
		Assert.assertEquals("{{10|20|40->50}50{50|60|70}}",
				tree.root.toString());
	}
	...
	public void test7Tree70Remove20() throws IOException {
		...
		Assert.assertEquals("{{10|20|30->40}40{40|50|60|70}}",
				tree.root.toString());
		tree.remove(20);
		Assert.assertEquals("{{10|30|40->50}50{50|60|70}}",
				tree.root.toString());
	}
	...
	public void test7Tree70Remove10() throws IOException {
		...
		Assert.assertEquals("{{10|20|30->40}40{40|50|60|70}}",
				tree.root.toString());
		tree.remove(10);
		Assert.assertEquals("{{20|30|40->50}50{50|60|70}}",
				tree.root.toString());
	}
	...
	public void test3Tree1234567Remove432() throws IOException {
		...
		tree.remove(4);
		tree.remove(3);
		Assert.assertEquals("{{{1->2}2{2->5}}5{{5->6}6{6|7}}}",
				tree.root.toString());
		tree.remove(2);
	...
	public void test3Tree123456789Remove175() throws IOException {
		...
		tree.add(9, 9);
		Assert.assertEquals(
				"{{{{1->2}2{2->3}}3{{3->4}4{4->5}}}5{{{5->6}6{6->7}}7{{7->8}8{8|9}}}}",
				tree.root.toString());
		tree.remove(1);
		Assert.assertEquals(
		...
		tree.remove(7);
		Assert.assertEquals(
				"{{{2->3}3{3->4}4{4->5}}5{{5->6}6{6->8}}8{{8->9}9{9}}}",
				tree.root.toString());
		tree.remove(5);
		Assert.assertEquals("{{{2->3}3{3->4}}4{{4->6}6{6->8}}8{{8->9}9{9}}}",
				tree.root.toString());
	}
	...
	public void testAddRemoveStress() throws IOException {
		...
		tree.add(5, 0);
		Assert.assertEquals("{{4->5}5{5|12->18}18{18|24}}",
				tree.root.toString());
		tree.add(17, 0);
		Assert.assertEquals("{{{4->5}5{5->12}}12{{12|17->18}18{18|24}}}",
				tree.root.toString());
		tree.add(21, 0);
		Assert.assertEquals(
				"{{{4->5}5{5->12}}12{{12|17->18}18{18->21}21{21|24}}}",
				tree.root.toString());
		tree.add(9, 0);
		Assert.assertEquals(
				"{{{4->5}5{5|9->12}}12{{12|17->18}18{18->21}21{21|24}}}",
				tree.root.toString());
		tree.add(8, 0);
		Assert.assertEquals(
				"{{{4->5}5{5->8}8{8|9->12}}12{{12|17->18}18{18->21}21{21|24}}}",
				tree.root.toString());
		tree.add(13, 0);
		Assert.assertEquals(
				"{{{4->5}5{5->8}8{8|9->12}}12{{12->13}13{13|17->18}}18{{18->21}21{21|24}}}",
				tree.root.toString());
		tree.add(3, 0);
		Assert.assertEquals(
				"{{{3|4->5}5{5->8}8{8|9->12}}12{{12->13}13{13|17->18}}18{{18->21}21{21|24}}}",
				tree.root.toString());
		tree.add(23, 0);
		Assert.assertEquals(
				"{{{3|4->5}5{5->8}8{8|9->12}}12{{12->13}13{13|17->18}}18{{18->21}21{21->23}23{23|24}}}",
				tree.root.toString());
		tree.add(11, 0);
		Assert.assertEquals(
				"{{{{3|4->5}5{5->8}}8{{8->9}9{9|11->12}}}12{{{12->13}13{13|17->18}}18{{18->21}21{21->23}23{23|24}}}}",
				tree.root.toString());
		tree.add(19, 0);
		Assert.assertEquals(
				"{{{{3|4->5}5{5->8}}8{{8->9}9{9|11->12}}}12{{{12->13}13{13|17->18}}18{{18|19->21}21{21->23}23{23|24}}}}",
				tree.root.toString());
		tree.add(14, 0);
		Assert.assertEquals(
				"{{{{3|4->5}5{5->8}}8{{8->9}9{9|11->12}}}12{{{12->13}13{13->14}14{14|17->18}}18{{18|19->21}21{21->23}23{23|24}}}}",
				tree.root.toString());
		tree.add(16, 0);
		Assert.assertEquals(
				"{{{{3|4->5}5{5->8}}8{{8->9}9{9|11->12}}}12{{{12->13}13{13->14}}14{{14->16}16{16|17->18}}18{{18|19->21}21{21->23}23{23|24}}}}",
				tree.root.toString());
		tree.add(7, 0);
		Assert.assertEquals(
				"{{{{3|4->5}5{5|7->8}}8{{8->9}9{9|11->12}}}12{{{12->13}13{13->14}}14{{14->16}16{16|17->18}}18{{18|19->21}21{21->23}23{23|24}}}}",
				tree.root.toString());
		tree.add(22, 0);
		Assert.assertEquals(
				"{{{{3|4->5}5{5|7->8}}8{{8->9}9{9|11->12}}}12{{{12->13}13{13->14}}14{{14->16}16{16|17->18}}18{{18|19->21}21{21|22->23}23{23|24}}}}",
				tree.root.toString());
		tree.add(6, 0);
		Assert.assertEquals(
				"{{{{3|4->5}5{5->6}6{6|7->8}}8{{8->9}9{9|11->12}}}12{{{12->13}13{13->14}}14{{14->16}16{16|17->18}}18{{18|19->21}21{21|22->23}23{23|24}}}}",
				tree.root.toString());
		tree.add(15, 0);
		Assert.assertEquals(
				"{{{{3|4->5}5{5->6}6{6|7->8}}8{{8->9}9{9|11->12}}}12{{{12->13}13{13->14}}14{{14|15->16}16{16|17->18}}18{{18|19->21}21{21|22->23}23{23|24}}}}",
				tree.root.toString());
		tree.add(1, 0);
		Assert.assertEquals(
				"{{{{1->3}3{3|4->5}}5{{5->6}6{6|7->8}}8{{8->9}9{9|11->12}}}12{{{12->13}13{13->14}}14{{14|15->16}16{16|17->18}}18{{18|19->21}21{21|22->23}23{23|24}}}}",
				tree.root.toString());
		tree.add(20, 0);
		Assert.assertEquals(
				"{{{{1->3}3{3|4->5}}5{{5->6}6{6|7->8}}8{{8->9}9{9|11->12}}}12{{{12->13}13{13->14}}14{{14|15->16}16{16|17->18}}}18{{{18->19}19{19|20->21}}21{{21|22->23}23{23|24}}}}",
				tree.root.toString());
		tree.add(2, 0);
		Assert.assertEquals(
				"{{{{1|2->3}3{3|4->5}}5{{5->6}6{6|7->8}}8{{8->9}9{9|11->12}}}12{{{12->13}13{13->14}}14{{14|15->16}16{16|17->18}}}18{{{18->19}19{19|20->21}}21{{21|22->23}23{23|24}}}}",
				tree.root.toString());
		tree.add(10, 0);
		Assert.assertEquals(
				"{{{{1|2->3}3{3|4->5}}5{{5->6}6{6|7->8}}8{{8->9}9{9->10}10{10|11->12}}}12{{{12->13}13{13->14}}14{{14|15->16}16{16|17->18}}}18{{{18->19}19{19|20->21}}21{{21|22->23}23{23|24}}}}",
				tree.root.toString());
	}
